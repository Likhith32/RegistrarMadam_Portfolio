  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-sans",
  {
    variants: {
      variant: {
        ...
        // Academic portfolio variants
        institutional: "bg-primary text-primary-foreground hover:bg-navy-light shadow-subtle hover:shadow-medium rounded-sm",
        hero: "bg-accent text-accent-foreground hover:bg-gold-light shadow-gold font-semibold tracking-wide rounded-sm",
        "hero-outline": "border-2 border-accent text-accent bg-transparent hover:bg-accent hover:text-accent-foreground font-semibold tracking-wide rounded-sm",
        maroon: "bg-secondary text-secondary-foreground hover:bg-maroon-light shadow-subtle rounded-sm",
        "nav-link": "text-foreground/80 hover:text-foreground hover:bg-transparent underline-offset-4 hover:underline rounded-sm",
      },
      size: {
