        ...
        <div className="container-wide px-6 lg:px-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="animate-fade-in-up">
              ...
              {isLoading ? (
                <div className="text-center py-8 text-muted-foreground">Loading workshops attended...</div>
              ) : workshopsAttended.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
                  No workshops attended records found.
                </div>
              ) : (
                <div className="space-y-3">
                  {workshopsAttended.map((workshop, index) => (
                    <div
                      key={index}
                      className="group flex items-start gap-3 p-4 bg-card rounded-lg border border-border hover:border-accent hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
                    >
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              ...
              {isLoading ? (
                <div className="text-center py-8 text-muted-foreground">Loading workshops organized...</div>
              ) : workshopsOrganized.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
                  No workshops organized records found.
                </div>
              ) : (
                <div className="space-y-3">
